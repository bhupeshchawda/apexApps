...
@XmlRootElement(name = "DiscreteConditionalProbability")
public class DiscreteConditionalProbability {

    @XmlElement(name = "Extension")
    protected List<Extension> extension;
    @XmlElement(name = "ParentValue", required = true)
    protected List<ParentValue> parentValue;
    @XmlElement(name = "ValueProbability", required = true)
    protected List<ValueProbability> valueProbability;
    ...
    /**
     * Gets the value of the valueProbability property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the valueProbability property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getValueProbability().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ValueProbability> getValueProbability() {
        if (valueProbability == null) {
            valueProbability = new ArrayList<ValueProbability>();
        }

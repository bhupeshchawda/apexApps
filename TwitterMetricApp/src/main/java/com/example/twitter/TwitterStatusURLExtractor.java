    ...
    public void process(Status status)
    {
      ...
      if (entities != null) {
        for (URLEntity ue: entities) {
          if (ue != null && (ue.getExpandedURL() != null || ue.getURL() != null)) { // see why we intermittently get NPEs
            String urlStr = (ue.getExpandedURL() == null ? ue.getURL() : ue.getExpandedURL()).toString();
            url.emit(urlStr);
          }
        }
      }

...
public class WindowedTopCounter<T> extends BaseOperator
{
  ...
  public final transient DefaultOutputPort<Collection<Collection<Pair<String, Object>>>> output = new DefaultOutputPort<>();
  ...
  public void endWindow()
  {
    ...
    while (topIter.hasNext()) {
      ...
      Collection<Pair<String, Object>> tableRow = new ArrayList<>();

      tableRow.add(new Pair<String, Object>(FIELD_TYPE, wh.identifier.toString()));
      tableRow.add(new Pair<String, Object>(FIELD_COUNT, wh.totalCount));

      data.add(tableRow);
    }

    Collections.sort((List<Collection<Pair<String, Object>>>)data, TwitterOutputSorter.INSTANCE);
  ...
  private static class TwitterOutputSorter implements Comparator<Collection<Pair<String, Object>>>
  {
    ...
    @Override
    public int compare(Collection<Pair<String, Object>> o1, Collection<Pair<String, Object>> o2)
    {
      Integer count1 = (Integer)getColumn(o1, FIELD_COUNT).second;
      Integer count2 = (Integer)getColumn(o2, FIELD_COUNT).second;

      return count1.compareTo(count2);
    }

    private Pair getColumn(Collection<Pair<String, Object>> row, String columnName) {
      for (Pair<String,Object> p : row) {
